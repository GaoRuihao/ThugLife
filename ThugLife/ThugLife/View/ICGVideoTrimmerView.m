...
- (void)resetSubviews
{
    ...
    [self.leftThumbView addGestureRecognizer:panGestureRecognizer];
    UIPanGestureRecognizer *rightPanGestureRecognizer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(moveOverlayView:)];
...
- (void)moveOverlayView:(UIPanGestureRecognizer *)gesture
{
    ...
    switch (gesture.state) {
        ...
        {
            center = self.leftOverlayView.center;
...
//            }
//            //------------------------------------------------------------------------------------------------------------
            self.leftOverlayView.center = CGPointMake(center.x + point.x, center.y);
